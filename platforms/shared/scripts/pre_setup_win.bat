...
echo.
echo Please fork the ocb repository from browser and then continue ...
PAUSE
echo.
...
"C:\Program Files\Git\bin\sh.exe" --login -i -c "git checkout develop && git remote add upstream https://github.com/sillysachin/ocb.git && git fetch upstream develop"
